...
public class UserResponse extends AbstractResponse {
    ...
    public UserInfo toUserInfo(){
        ...
        info.setAvatarMediaid(getAvatarMediaid());
        info.setDepartment(getDepartment());
        info.setEnglishName(getEnglishName());
        info.setEmail(getEmail());
        info.setLeader(getLeader());
        info.setOrder(getOrder());
        info.setExtattr(getExtattr());
        info.setMobile(getMobile());
        info.setPosition(getPosition());
        info.setTelephone(getTelephone());
